...
长布是一款本地优先的个人笔记工具，默认以简体中文界面与中文文档提供体验。

当前发布版本：`v1.4.0`

## v1.4.0 更新

- 补齐网页 favicon、Electron 窗口图标与 macOS / Windows 打包图标链路
- 修复打包版原生依赖缺失导致的启动问题
- 修复 Electron 打包版 `file://` 场景下的资源路径白页问题

## 下载与安装

- GitHub Releases 默认提供中文说明
- 当前优先提供 macOS 安装包（Apple Silicon / arm64）
- 安装包文件名以 `长布-1.4.0-arm64.dmg` 为准
